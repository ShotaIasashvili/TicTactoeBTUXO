...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkWinner() {
            ...
            {
                Toast.makeText(this,"მოთამაშე 1-მა გაიმარჯვა",Toast.LENGTH_SHORT).show()
                f=1
                setFalse()
            ...
            {
                Toast.makeText(this,"მოთამაშე 2-ემ გაიმარჯვა",Toast.LENGTH_SHORT).show()
                f=1
                setFalse()
            ...
            {
                Toast.makeText(this,"მოთამაშე 1-ელმა გაიმარჯვა",Toast.LENGTH_SHORT).show()
                f=1
                setFalse()
            ...
            else if(player2arr.contains(3)&&player2arr.contains(5)&&player2arr.contains(7))
            {
                ...
                if ((sum==9) && (f ==0)) {
                    Toast.makeText(this, "ნიჩიაა, წაით სახლში !!!", Toast.LENGTH_SHORT).show()
                    setFalse()
                }
            }
